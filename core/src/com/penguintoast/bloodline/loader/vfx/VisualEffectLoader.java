...
public class VisualEffectLoader extends SynchronousAssetLoader<VisualEffect, VisualEffectLoader.VisualEffectParameter> {
	...
	private VisualEffect loadAnimation(DataFile data) {
		...
		if(type == null || type.equalsIgnoreCase("NORMAL")) {
			anim = new Animation(AnimationVisualEffect.FRAME_DURATION, textures, PlayMode.NORMAL);
		} else if(type.equalsIgnoreCase("LOOP")) {
			anim = new Animation(AnimationVisualEffect.FRAME_DURATION, textures, PlayMode.LOOP);
		} else if(type.equalsIgnoreCase("LOOP_PINGPONG")) {
			anim = new Animation(AnimationVisualEffect.FRAME_DURATION, textures, PlayMode.LOOP_PINGPONG);
		} else if(type.equalsIgnoreCase("REVERSED")) {
			anim = new Animation(AnimationVisualEffect.FRAME_DURATION, textures, PlayMode.REVERSED);
		} else if(type.equalsIgnoreCase("LOOP_REVERSED")) {
			anim = new Animation(AnimationVisualEffect.FRAME_DURATION, textures, PlayMode.LOOP_REVERSED);
		} else if(type.equalsIgnoreCase("LOOP_RANDOM")) {
			anim = new Animation(AnimationVisualEffect.FRAME_DURATION, textures, PlayMode.LOOP_RANDOM);
		}
