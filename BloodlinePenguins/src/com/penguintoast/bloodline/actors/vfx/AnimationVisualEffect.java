...
public class AnimationVisualEffect extends VisualEffect {
	...
	public boolean isFinished() {
		return (animation.getPlayMode() == Animation.NORMAL || animation.getPlayMode() == Animation.REVERSED) ? animation.isAnimationFinished(timer) : false;
	}
	
	@Override
	public VisualEffect newInstance() {
		VisualEffect out = new AnimationVisualEffect(new Animation(animation.frameDuration, textures, animation.getPlayMode()), textures);
